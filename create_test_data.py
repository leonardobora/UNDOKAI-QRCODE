...
def create_sample_data():
    ...
    with app.app_context():
        ...
        # Sample departments
        departments = ['TI', 'RH', 'Financeiro', 'Marketing', 'Vendas', 'Operações', 'Administração']
        
        # Create sample participants
        participants_data = [
            ('João Silva', 'joao.silva@lightera.com.br', '11987654321', 'TI'),
            ('Maria Santos', 'maria.santos@lightera.com.br', '11876543210', 'RH'),
            ('Carlos Oliveira', 'carlos.oliveira@lightera.com.br', '11765432109', 'Financeiro'),
            ('Ana Costa', 'ana.costa@lightera.com.br', '11654321098', 'Marketing'),
            ('Pedro Mendes', 'pedro.mendes@lightera.com.br', '11543210987', 'TI'),
            ('Lucia Ferreira', 'lucia.ferreira@lightera.com.br', '11432109876', 'Vendas'),
            ('Roberto Lima', 'roberto.lima@lightera.com.br', '11321098765', 'Operações'),
            ('Patricia Souza', 'patricia.souza@lightera.com.br', '11210987654', 'RH'),
            ('Fernando Alves', 'fernando.alves@lightera.com.br', '11109876543', 'Administração'),
            ('Camila Rocha', 'camila.rocha@lightera.com.br', '11098765432', 'Marketing'),
            ('Marcos Pereira', 'marcos.pereira@lightera.com.br', '11987654320', 'TI'),
            ('Julia Nascimento', 'julia.nascimento@lightera.com.br', '11876543209', 'Financeiro'),
            ('Ricardo Barbosa', 'ricardo.barbosa@lightera.com.br', '11765432108', 'Vendas'),
            ('Isabela Martins', 'isabela.martins@lightera.com.br', '11654321097', 'Operações'),
        ...
        dependent_names = [
            'Ana Silva Jr.', 'Pedro Santos Jr.', 'Maria Oliveira Jr.',
            'João Costa Jr.', 'Lucia Mendes Jr.', 'Carlos Ferreira Jr.'
        ]
        ...
        for i, participant in enumerate(checked_in_participants):
            ...
            checkin_time = base_time + timedelta(minutes=random.randint(0, 240))  # 4 hours spread
            checkin = CheckIn(
        ...
        print(f"📊 Attendance rate: {(checked_in_count / len(participants)) * 100:.1f}%")
