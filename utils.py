...
# Import app and db only when needed to avoid circular imports
...
def send_qr_email(participant, qr_image_data=None):
    ...
    try:
        ...
        if qr_image_data:
            ...
            img.add_header(
                "Content-Disposition",
                f"attachment; filename=qr_code_{participant.qr_code}.png",
            )
            msg.attach(img)
...
def create_sample_delivery_items():
    ...
    sample_items = [
        ...
        # Brinquedos category
        {
            "nome": "Brinquedo 0-3 anos",
            "categoria": "Brinquedos",
            "estoque_inicial": 150,
            "estoque_atual": 150,
        },
        {
            "nome": "Brinquedo 4-7 anos",
            "categoria": "Brinquedos",
            "estoque_inicial": 200,
            "estoque_atual": 200,
        },
        {
            "nome": "Brinquedo 8-12 anos",
            "categoria": "Brinquedos",
            "estoque_inicial": 180,
            "estoque_atual": 180,
        },
        ...
        {
            "nome": "Kit Escolar Fundamental",
            "categoria": "Material Escolar",
            "estoque_inicial": 300,
            "estoque_atual": 300,
        },
        {
            "nome": "Kit Escolar Médio",
            "categoria": "Material Escolar",
            "estoque_inicial": 200,
            "estoque_atual": 200,
        },
...
def get_checkin_statistics():
    ...
    dept_stats = (
        db.session.query(
            Participant.departamento, db.func.count(Participant.id).label("count")
        )
        .group_by(Participant.departamento)
        .all()
    )
