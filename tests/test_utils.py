...
from utils import generate_qr_code, send_qr_email, create_sample_delivery_items, get_checkin_statistics
from models import Participant, CheckIn, Dependent, DeliveryItem
from app import db
...
class TestSampleDataCreation:
    ...
    def test_create_sample_delivery_items(self, test_app):
        ...
        with test_app.app_context():
            ...
            expected_categories = {'Festa', 'Cesta Básica', 'Brinquedos', 'Material Escolar'}
            ...
            escolar_items = DeliveryItem.query.filter_by(categoria='Material Escolar').all()
    ...
    def test_sample_delivery_items_structure(self, test_app):
        ...
        with test_app.app_context():
            ...
            for item in items:
                ...
                assert item.estoque_inicial == item.estoque_atual  # Initial stock should equal current
...
class TestStatistics:
    ...
    def test_get_checkin_statistics_empty(self, test_app):
        ...
        with test_app.app_context():
            ...
            assert all(hour_data['count'] == 0 for hour_data in stats['hourly_checkins'])
    ...
    def test_get_checkin_statistics_with_data(self, test_app, db_with_data):
        ...
        with test_app.app_context():
            ...
            assert all('hour' in hour_data and 'count' in hour_data 
    ...
    def test_get_checkin_statistics_multiple_departments(self, test_app):
        ...
        with test_app.app_context():
            ...
            participants = [
                Participant(nome="João TI", email="joao@lightera.com", 
                           departamento="TI", qr_code="QR001"),
                Participant(nome="Maria RH", email="maria@lightera.com", 
                           departamento="RH", qr_code="QR002"),
                Participant(nome="Pedro TI", email="pedro@lightera.com", 
                           departamento="TI", qr_code="QR003"),
                Participant(nome="Ana Vendas", email="ana@lightera.com", 
                           departamento="Vendas", qr_code="QR004"),
            ]
