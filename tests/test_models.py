...
class TestDependent:
    ...
    def test_dependent_relationship(self, test_app, sample_participant, sample_dependent):
...
class TestDeliveryItem:
    ...
    def test_delivery_item_properties(self, test_app, sample_delivery_item):
        ...
        with test_app.app_context():
            ...
            assert sample_delivery_item.items_remaining == sample_delivery_item.estoque_atual
...
class TestDeliveryLog:
    ...
    def test_delivery_log_creation(self, test_app, sample_participant, sample_delivery_item):
    ...
    def test_delivery_log_relationships(self, test_app, sample_participant, sample_delivery_item):
...
class TestModelIntegration:
    ...
    def test_complete_participant_workflow(self, test_app):
        ...
        with test_app.app_context():
            ...
            # Add dependents
            dependent1 = Dependent(nome="Lucas Santos", idade=10, participant_id=participant.id)
            dependent2 = Dependent(nome="Carla Santos", idade=6, participant_id=participant.id)
            ...
            saved_participant = Participant.query.filter_by(email="ana.santos@lightera.com").first()
            ...
            # Verify deliveries
            total_items_delivered = sum(d.quantidade for d in saved_participant.deliveries)
